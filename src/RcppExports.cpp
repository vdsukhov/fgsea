...
// gesecaCpp
NumericVector gesecaCpp(const NumericMatrix& E, const NumericVector& inpScores, unsigned genesetSize, unsigned sampleSize, int seed, double eps, double moveScale);
RcppExport SEXP _fgsea_gesecaCpp(SEXP ESEXP, SEXP inpScoresSEXP, SEXP genesetSizeSEXP, SEXP sampleSizeSEXP, SEXP seedSEXP, SEXP epsSEXP, SEXP moveScaleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(gesecaCpp(E, inpScores, genesetSize, sampleSize, seed, eps, moveScale));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fgsea_gesecaCpp", (DL_FUNC) &_fgsea_gesecaCpp, 7},
    {NULL, NULL, 0}
};
