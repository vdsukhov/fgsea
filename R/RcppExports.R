...
gesecaCpp <- function(E, inpScores, genesetSize, sampleSize, seed, eps, moveScale = 1.0) {
    .Call('_fgsea_gesecaCpp', PACKAGE = 'fgsea', E, inpScores, genesetSize, sampleSize, seed, eps, moveScale)
}
